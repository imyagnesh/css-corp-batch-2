...
// Sorting
const sortMethod = users.sort((a, b) => a.age - b.age)
console.log(sortMethod);

// Reduce + Sort Method
const sortByAge = sortMethod.reduce((previousValue, currentValue) => {
...
const sortedByAge = users.reduce((previousValue, currentValue) => {
    ...
    const indexofMethod = previousValue[ageFormat].indexOf( x => {
