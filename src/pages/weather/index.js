...
export default class Weather extends Component {
    constructor(props) {
        ...
        this.state = {
            resultValue: "",
            weatherDeatils: [
            { id: 1, cityName: "Hyderabad", temp: "24°C"},
            { id: 2, cityName: "Chennai", temp: "30°C" },
            { id: 3, cityName: "Bangalore", temp: "27°C" },
            { id: 4, cityName: "Goa", temp: "35°C"}]
        };
    ...
    checkWeather = (event) => {
        ...
        const weatherCity = this.state.weatherDeatils.find(x => x.city.toLowerCase() === city.toLowerCase());
        this.setState(({ weatherDeatils, resultValue }) => ({
            weatherDeatils,
    ...
    render() {
        const { weatherDeatils, resultValue } = this.state;
