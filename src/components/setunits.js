            ...
            <div className="border border-3">
                <div>
                    ...
                    <div className="relative inline-block w-1/2 text-gray-700">
                        <select className="w-full h-10 pl-3 pr-6 text-base placeholder-gray-600 border-0 rounded-lg appearance-none focus:shadow-outline" onChange={handleChange}>
